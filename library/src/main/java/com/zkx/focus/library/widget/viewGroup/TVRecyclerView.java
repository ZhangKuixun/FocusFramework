...
import com.zkx.focus.library.utils.Loger;
...
public class TVRecyclerView extends RecyclerView implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, @Nullable Rect previouslyFocusedRect) {
        ...
        if (mKeyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
            if (mDirectionListener != null) {
                mDirectionListener.onDirection(gainFocus);
            }
        }
     ...
     * 初始化时使用
     */
    public void requestDefaultFocus(final TVRecyclerView view) {
...
//                }
    ...
    public void onScrollStateChanged(int state) {
        Log.e("akui", "onScrollStateChanged");
...
//        }
    ...
    private boolean handleKeyDown(int keyCode, KeyEvent event) {
        ...
        Loger.e("nextFocusedView=" + nextFocusedView);
        if (hasInBorder(direction, nextFocusedView)) {
            return mOnInBorderKeyEventListener.onInBorderKeyEvent(direction, keyCode, event, mItemView);
        }
    ...
    public void setDirectionListener(OnDirectionListener directionListener) {
    ...
    public interface OnInBorderKeyEventListener {
        boolean onInBorderKeyEvent(int direction, int keyCode, KeyEvent event, View itemView);
    }
    ...
    public interface OnDirectionListener {
         ...
         */
        void onDirection(boolean gainFocus);
    }
